...
/**
 * PhotoInterface implements the photo view functionalities.
 * @author Magdi Aref
 * @author Muskan Burman
 */
public class PhotoInterface extends AppCompatActivity {
    ...
    /**
     * onCreate updates the photo view on getting the photo.
    ...
    /**
     * Lets user add a tag to the photo.
     * @param view  as view
     */
    ...
    /**
     * Lets user remove the selected tag from the photo.
     * @param view as view
     */
